    ...
    def draw(self):
        ...
        if self.copyright:
            for line, (x, y) in prep_text(
                [
                    ...
                    "    Copyright (C) 2009 Marcus Dreier <m-rei@gmx.net>",
                    "    Copyright (C) 2010 Ryan Kavanagh <rak@ryanak.ca>",
                    "",
        ...
        for i in range(0, n):
            ...
            if self.items[i][1] == 1:
                ...
                result.blit(
                    Settings.box,
                    (25, 2.5 * Settings.MENU_LINEFEED + Settings.MENU_LINEFEED * i - 8),
                )
                if self.items[i][2]:
                    if self.items[i][3]:
                        result.blit(
            ...
            result.blit(
                ...
                (
                    25 + offset,
                    2.5 * Settings.MENU_LINEFEED + Settings.MENU_LINEFEED * i,
                ),
            )
...
class Welcome(Menu):
    def __init__(self):
        ...
        header = prep_text(["Welcome to Slingshot!"], True, hfont, 0, (255, 255, 255))[
            0
        ]
        self.img.blit(header[0], ((self.img.get_width() - header[1][0]) / 2, 0))
        # Instructions font
        ...
        self.img.blit(
            instructions[0], ((self.img.get_width() - instructions[1][0]) / 2, 60)
        )
        for line, (x, y) in prep_text(
            [
                "Slingshot is:",
