...
class Settings:
    ...
    g = 120  # gravity
    MAXPOWER = 350
    PLANET_SHIP_DISTANCE = (
        75  # this is actually the distance towards the edge left and right
    )
    ...
    FPS = 30
    KEY_REPEAT = (
        30  # time between repeating key events, keep a little lower than 1000 / FPS
    )
    KEY_DELAY = 250
